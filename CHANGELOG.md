...
Todas as atualizações relevantes do repositório são registradas aqui, da mais recente para a mais antiga.

Formato de cada entrada: `AAAA-MM-DD` — descrição da mudança.
